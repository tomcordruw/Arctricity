                    ...
                    child: Container(
                      child: FutureBuilder(
                        future: Future.wait([
                          ...
                          getHistorical(numDocuments, selectedPlaceholder),
                          fetchApiData(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            if (docs.isNotEmpty) {
                              List<dynamic> pricesList = docs[2]["prices"];
                              ...
                              if (currentHour != null) {
                                currentPrice = currentHour.price.toDouble();
                              }
                              ...
                              timeList = docs[3]["hourly"]["time"]
                                  .cast<String>()
                                  .toList();
                              tempList = docs[3]["hourly"]["temperature_2m"]
                                  .cast<double>()
                                  .toList();
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          ...
                          var priceGraph = Container(
                            ...
                            PriceWidget(priceData, startDateList)
                          ])));
                          return priceGraph;
                        }
                        return CircularProgressIndicator();
